...
public class YACLConfigCategoryAdapter {
	...
	protected static List<dev.isxander.yacl3.api.ConfigCategory> toYaclConfigCategories(List<net.azureaaron.dandelion.api.ConfigCategory> categories) {
	...
	private static dev.isxander.yacl3.api.ConfigCategory toYaclConfigCategory(net.azureaaron.dandelion.api.ConfigCategory category) {
